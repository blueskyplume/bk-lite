...
# 问题:
#   SessionEventRelation.event 是 ForeignKey，Django 已自动创建索引
#   AddIndex 再次创建索引导致 MySQL 报错 "Duplicate key name"
# 方案:
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # MySQL 支持 TextField → JSONField 类型变更，保留原始 AlterField
