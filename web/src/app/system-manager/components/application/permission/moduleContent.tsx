      ...
      {isEditable ? (
        <CustomTable
          ...
          rowSelection={{
            ...
            onSelectAll: (selected: boolean, _selectedRows: DataPermission[], changeRows: DataPermission[]) => {
...
const ModuleContent: React.FC<ModuleContentProps> = ({
  ...
  if (subModule && moduleHasSubModules) {
    currentModule = findPermissionInTree(modulePermission as ProviderPermissionConfig, subModule);
  } else {
